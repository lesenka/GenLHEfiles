...
for M in 1 2 5 10 20 30 40 50 60 80 100 130 150 200 400 600 800 1000; do
    for FL in "e" "mu" "tau" "2l" "3l"; do
        ...
        echo "/store/group/phys_generator/cvmfs/gridpacks/slc6_amd64_gcc481/13TeV/madgraph/V5_2.4.2/HeavyNeutrino_VBF_trilepton/v1/${MODEL}_tarball.tar.xz"
        xrdcp -f ${GRIDPACKDIR}/${MODEL}/${MODEL}_tarball.tar.xz root://eoscms.cern.ch///eos/cms/store/group/phys_generator/cvmfs/gridpacks/slc6_amd64_gcc481/13TeV/madgraph/V5_2.4.2/HeavyNeutrino_VBF_trilepton/v1/${MODEL}_tarball.tar.xz
    done
done
